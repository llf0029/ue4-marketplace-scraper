...
class WebpageTest(unittest.TestCase):
    ...
    def setUp(self):
        query_url = 'https://www.unrealengine.com/marketplace/assets?lang=&q=test'
    ...
    def test_strip_tags(self):
        html = '<a href="testlink.com/test">No tags <strong>here</strong>, boss</a>'
    ...
    def test_find_links_2(self):
        ...
        actual = self.wp.find_links(tag, class_name)
        expected = [
            'https://www.unrealengine.com/marketplace/crash-test-robot-dummy', 
            'https://www.unrealengine.com/marketplace/32-hdris-lighting-environments'
        ]
        self.assertEqual(actual, expected)
    ...
    def test_find_images(self):
        ...
        expected = [
            'https://cdn1.epicgames.com/ue/item/CrashTestRD_Thumb-284x284-1dd187177c17232e2fe7da2b4047fd4d.png',
            'https://cdn1.epicgames.com/ue/item/HDRIs_Thumbnail-284x284-3e3950364b72f446cd86a64bde521df4.png'
        ]
        self.assertEqual(actual, expected)
